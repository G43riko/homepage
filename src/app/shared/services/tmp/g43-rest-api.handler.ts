...
import { HttpStatusCodes } from "gtools/enums";
import { Observable, throwError } from "rxjs";
import { map } from "rxjs/operators";
import { SimpleMemoryDatabaseService } from "./simple-memory-database.service";
...
export class AbstractRestApiHandler<T extends { id: number }> {
    public constructor(private readonly database: SimpleMemoryDatabaseService<T>, private readonly path: string, private urlMap = {
